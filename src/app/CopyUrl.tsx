  ...
  return (
    <div className="flex flex-col gap-1">
      <div className="flex flex-row">
        <div className="w-96 h-12 bg-slate-100 shadow-sm border rounded-lg hove border-sky-950 flex items-center px-3">
          {url}
        </div>
        <button
          onClick={() => {
          ...
          className={classNames(
            ...
            'transition duration-200 text-white rounded-lg  shadow-sm h-12 w-44 ml-2'
          )}>
